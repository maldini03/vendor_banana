...
org_manifest = "bananadroid-devices"  # leave empty if org is provided in manifest
org_display = "bananadroid-devices"  # needed for displaying

banana_manifest = ".repo/manifests/banana.xml"
...
def add_to_manifest(repos, fallback_branch=None):
    ...
    bananam = load_manifest(banana_manifest)
    ...
    for repo in repos:
        ...
        elif exists_in_tree(bananam, repo_target) != None:
            existing_m_project = exists_in_tree(bananam, repo_target)
