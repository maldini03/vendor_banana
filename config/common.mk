...
# Backup Tool
PRODUCT_COPY_FILES += \
    vendor/banana/build/tools/backuptool.sh:install/bin/backuptool.sh \
    vendor/banana/build/tools/backuptool.functions:install/bin/backuptool.functions \
    vendor/banana/build/tools/50-banana.sh:$(TARGET_COPY_OUT_SYSTEM)/addon.d/50-banana.sh

PRODUCT_ARTIFACT_PATH_REQUIREMENT_ALLOWED_LIST += \
    system/addon.d/50-banana.sh

ifneq ($(strip $(AB_OTA_PARTITIONS) $(AB_OTA_POSTINSTALL_CONFIG)),)
PRODUCT_COPY_FILES += \
    vendor/banana/build/tools/backuptool_ab.sh:$(TARGET_COPY_OUT_SYSTEM)/bin/backuptool_ab.sh \
    vendor/banana/build/tools/backuptool_ab.functions:$(TARGET_COPY_OUT_SYSTEM)/bin/backuptool_ab.functions \
    vendor/banana/build/tools/backuptool_postinstall.sh:$(TARGET_COPY_OUT_SYSTEM)/bin/backuptool_postinstall.sh
...
PRODUCT_COPY_FILES += \
    vendor/banana/prebuilt/common/etc/sensitive_pn.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/sensitive_pn.xml
